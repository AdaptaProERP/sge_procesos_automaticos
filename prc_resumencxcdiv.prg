...
PROCE MAIN(uPar)
  ...
  oErp:cDescri :="Cuentas por Cobrar "+ALLTRIM(TRAN(nDolar,oErp:cPicture))+"("+oDp:cMonedaExt+")"+CRLF+;
                 "Actualizado "+ALLTRIM(TRAN(nMonto,oErp:cPicture))+" ("+oDp:cMoneda+")"+" Actualizado al "+DTOC(dFecha)
