...
PROCE MAIN(uPar)
     ...
     SQLUPDATE([DPCAMPOS],{[CAM_DEC]    ,[CAM_FORMAT]},{6,[999,999.999999]},[CAM_NAME="HMN_VALOR"])
     ...
     oErp:cDescri:="Activado Seis(6) Decimales para el uso Divisas (Peso Colombiano)"+CRLF+"Formato " +oDp:cPictValCam
