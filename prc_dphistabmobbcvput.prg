...
PROCE MAIN(uPar)
   LOCAL cSql,cWhere,cUrl:="https://www.bcv.org.ve/"
   LOCAL dFecha:=NIL
   LOCAL nCant,nValor,nDias:=0,oFrmHisMon
   ...
   IF nValor=0 .AND. oDp:lPanel  
      ...
      EJECUTAR("DPHISMON",1,"DBC",oDp:dFecha,"00:00:00",NIL,.T.)
      ...
      IF ISSQLFIND("DPPROCESOS","PRC_CODIGO"+GetWhere("=","DPHISTABMOBCOP")+ " AND PRC_ACTIVO=1")
         EJECUTAR("PUTBCVCOP",NIL,NIL,4000) // 
      ENDIF
