...
PROCE MAIN(uPar)
     ...
     SQLUPDATE([DPCAMPOS],{[CAM_DEC]    ,[CAM_FORMAT]},{4,[999,999,999.9999]},[CAM_NAME="HMN_VALOR"])
     ...
     oErp:cDescri:="Activado Cuatro(4) Decimales para el uso Divisas (Dólar)"+CRLF+"Formato " +oDp:cPictValCam
